               ...
               <form action="simpan.php" method="post">
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                     ...
                     id="rt" placeholder="01" value="<?php echo $rt; ?>"><span class="warning"><?php echo $error_rt; ?></span>
                   </div>
                 </div>
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                     ...
                     id="rw" placeholder="01" value="<?php echo $rw; ?>"><span class="warning"><?php echo $error_rw; ?></span>
                   </div>
                 </div>
