...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"]=="POST"){
        if(empty($_POST["nama"])){
            ...
            if(!preg_match("/^[a-zAZ ]*$/", $nama)){
                $name_err = "Inputan hanya boleh huruf dan spasi";
            }
        }
    ...
    <div class = "card-body">
        <form method = "POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class = "form-group row">
                ...
                <div class = "col-sm-10">
                <input type="text" name="email" class="form-control <?php echo ($error_nama !="" ? "is-invalid": "");?>"
            ...
            <div class = "form-group row">
                ...
                id="web" placeholder="Web" value="<?php echo $web; ?>">
            ...
            <div class = "form-group row">
                ...
                id="telp" placeholder="Telp" value="<?php echo $telp; ?>">
            ...
            <div class = "form-group row">
                ...
                <div class = "col-sm-10">
                <input type="text" name="pesan" class="form-control <?php echo ($error_pesan !="" ? "is-invalid": "");?>"
                id="pesan" placeholder="Pesan" value="<?php echo $pesan; ?>">
